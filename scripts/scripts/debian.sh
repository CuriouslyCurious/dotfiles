#!/bin/bash
# https://gist.githubusercontent.com/superboum/1c7adcd967d3e15dfbd30d04b9ae6144/raw/dfd5d936b0bb2062a4d5e430648970564605d254/build.sh
...
debootstrap --variant=minbase --arch amd64 bullseye ${ROOTFS} http://deb.debian.org/debian/
...
cat << EOF | chroot ${ROOTFS} /bin/bash
  ...
  apt-get update
  apt-get install -y linux-image-amd64 linux-headers-amd64 grub-efi vim openssh wget
